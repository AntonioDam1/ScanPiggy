...
class CategoriasIngresosAdapter(private val context: Context, private val imagenes: IntArray, private val nombres: Array<String>, private val colores: IntArray) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        view.setOnClickListener {
            ...
            if (nombres[position] == "Otros") {
                ...
                val intent = Intent(context, AnadirCategoriaIngresos::class.java)
